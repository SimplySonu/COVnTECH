...
public class India_Activity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<dataFormat>>{
    ...
    public Loader<List<dataFormat>> onCreateLoader(int id, Bundle args) {
        return new IndiaLoader(this, USGS_REQUEST_URL);
    }
